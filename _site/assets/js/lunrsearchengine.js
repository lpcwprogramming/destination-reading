...
var documents = [{
    "id": 0,
    "url": "/destination-reading/404.html",
    "title": "404",
    "body": "404 Page does not exist!Please use the search bar at the top or visit our homepage! "
    }, {
    "id": 1,
    "url": "/destination-reading/about",
    "title": "About",
    "body": "      Welcome to Destination: Reading!    I created this blog so I could have a place where I could talk about books and share my reading experiences with others who love books as much as I do. I like to challenge myself to go beyond my comfort zones. Here you’ll find reading challenges I set myself.     If you want to get in touch with me send me an email at destinationreadingblog@gmail. com     Hope you enjoy your stay!         "
    }, {
    "id": 2,
    "url": "/destination-reading/categories",
    "title": "Categories",
    "body": ""
    }, {
    "id": 3,
    "url": "/destination-reading/",
    "title": "Home",
    "body": "{% if page. url == “/” %}       Featured:       {% for post in site. posts %}    {% if post. featured == true %}      {% include featuredbox. html %}    {% endif %}  {% endfor %}  {% endif %}       All Stories:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 4,
    "url": "/destination-reading/reading-challenges",
    "title": "Reading Challenges",
    "body": "                2021 Goodreads Challenge    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.                          Around the World in 250 Books    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.                          The All American Quest    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.                          #ChiTown    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.           "
    }, {
    "id": 5,
    "url": "/destination-reading/robots.txt",
    "title": "",
    "body": "      Sitemap: {{ “sitemap. xml”   absolute_url }}   "
    }, {
    "id": 6,
    "url": "/destination-reading/page2/",
    "title": "Home",
    "body": "{% if page. url == “/” %}       Featured:       {% for post in site. posts %}    {% if post. featured == true %}      {% include featuredbox. html %}    {% endif %}  {% endfor %}  {% endif %}       All Stories:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 7,
    "url": "/destination-reading/page3/",
    "title": "Home",
    "body": "{% if page. url == “/” %}       Featured:       {% for post in site. posts %}    {% if post. featured == true %}      {% include featuredbox. html %}    {% endif %}  {% endfor %}  {% endif %}       All Stories:         {% for post in paginator. posts %}    {% include postbox. html %}    {% endfor %}    {% include pagination. html %}"
    }, {
    "id": 8,
    "url": "/destination-reading/powerful-things-markdown-editor/",
    ...
    "id": 9,
    "url": "/destination-reading/first-mass-produced/",
    ...
    "id": 10,
    "url": "/destination-reading/education/",
    ...
    "id": 11,
    "url": "/destination-reading/acumulated-experience/",
    ...
    "id": 12,
    "url": "/destination-reading/about-bundler/",
    "title": "About Bundler",
    ...
    "id": 13,
    "url": "/destination-reading/we-all-wait-for-summer/",
    ...
    "id": 14,
    "url": "/destination-reading/tree-of-codes/",
    "title": "Tree of Codes",
    ...
    "id": 15,
    "url": "/destination-reading/red-riding/",
    "title": "Red Riding Hood",
    "body": "2018/01/12 - The first mass-produced book to deviate from a rectilinear format, at least in the United States, is thought to be this 1863 edition of Red Riding Hood, cut into the shape of the protagonist herself with the troublesome wolf curled at her feet. Produced by the Boston-based publisher Louis Prang, this is the first in their “Doll Series”, a set of five “die-cut” books, known also as shape books — the other titles being Robinson Crusoe, Goody Two-Shoes (also written by Red Riding Hood author Lydia Very), Cinderella, and King Winter. An 1868 Prang catalogue would later claim that such “books in the shape of a regular paper Doll… originated with us”.  It would seem the claim could also extend to die cut books in general, as we can’t find anything sooner, but do let us know in the comments if you have further light to shed on this! Such books are, of course, still popular in children’s publishing today, though the die cutting is not now limited to mere outlines, as evidenced in a beautiful 2014 version of the same Little Red Riding Hood story. The die cut has also been employed in the non-juvenile sphere as well, a recent example being Jonathan Safran Foer’s ambitious Tree of Codes. As for this particular rendition of Charles Perrault’s classic tale, the text and design is by Lydia Very (1823-1901), sister of Transcendentalist poet Jones Very. The gruesome ending of the original — which sees Little Red Riding Hood being gobbled up as well as her grandmother — is avoided here, the gore giving way to the less bloody aims of the morality tale, and the lesson that one should not disobey one’s mother. "
    }, {
    "id": 16,
    "url": "/destination-reading/press-and-education/",
    ...
    "id": 17,
    "url": "/destination-reading/options-for-creating-new-site-with-jekyll/",
    ...
    "id": 18,
    "url": "/destination-reading/never-stopped-worrying-never-loved-bomb/",
    ...
    "id": 19,
    "url": "/destination-reading/is-intelligence-enough/",
    ...
    "id": 20,
    "url": "/destination-reading/quick-start-guide/",
    ...
    "id": 21,
    "url": "/destination-reading/customer-service/",
